...
\gradename{docteur}
\univ{de l'Université Paris-Saclay}
\logos{tintin}{U-PSUD}{}
\specialite{Physique}
\ecoledoctnum{564}
\ecoledoctacro{EDPIF}
...
\title{La laine des Dupondt \linebreak[1]  au «Pays de l'or noir»}
\titleen{Dupondt's whool \linebreak[1] in ``Land of Black Gold’’}
...
\dateiso{1999-04-01}
\defensecity{à Orsay}
\reference{1999SACL0000}
\atinstitution{à l’université Paris Sud}
\atlab{au Laboratoire de tintinologie théorique et appliquée}
% Jury as LaTeX Tabular with -+- as separator. Pas de président avant soutenance
\jury{%
