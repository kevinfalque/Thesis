...
\graphicspath{{./}{./fig/}{./chap2_theory/fig/}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{chap2_theory/fig/cavity_geometry.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{chap2_theory/fig/DBR.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{chap2_theory/fig/band_theory.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{chap2_theory/fig/intra_band_dressed_bubbles.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{chap2_theory/fig/InGaAs.pdf}
...
\begin{figure}[]
    \centering
    \includegraphics[width=0.8\linewidth]{chap2_theory/fig/polariton_cavity.pdf}
...
\begin{figure}[]
    \centering
    \includegraphics[width=1\linewidth]{chap2_theory/fig/wedge_and_hopfields.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{chap2_theory/fig/anticrossing.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{chap2_theory/fig/polariton_bec.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{chap2_theory/fig/bistability_grynberg.pdf}
...
\begin{equation}
    \Delta = g^2 \left( \delta^2 - \dfrac{3\gamlp^2}{2}\right).
\end{equation}
...
From this one can find that the density corresponding to the turning point fullfill $\delta(\kp)=gn$. 

\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{chap2_theory/fig/bistability.pdf}
    \caption{\textbf{Optical bistability in a polariton fluid.} a) The polariton density as a function of the pump intensity when $\delta>\frac{\sqrt{3}\gamlp}{2}$. The blue point represent the so called turning point at which the detuning is exactly equal to the interaction energy.
    b) Polariton density as a function of $\delta$ for a fixed pump intensity. c) Polariton density as a function of the pump intensity for different values of $\delta$, bistability is observed when $\delta>\frac{\sqrt{3}\gamlp}{2}$.}
